  ...
  return (
    <div className='space-y-2'>
      {supportRetrievalMethods.includes(RETRIEVE_METHOD.semantic) && (
        <OptionCard disabled={disabled} icon={<img className='h-4 w-4' src={retrievalIcon.vector} alt='' />}
      ...
      {supportRetrievalMethods.includes(RETRIEVE_METHOD.fullText) && (
        <OptionCard disabled={disabled} icon={<img className='h-4 w-4' src={retrievalIcon.fullText} alt='' />}
      ...
      {supportRetrievalMethods.includes(RETRIEVE_METHOD.hybrid) && (
        <OptionCard disabled={disabled} icon={<img className='h-4 w-4' src={retrievalIcon.hybrid} alt='' />}
          title={
