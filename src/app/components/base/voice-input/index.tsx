...
const VoiceInput = ({
  ...
  const handleStopRecorder = useCallback(async () => {
    ...
    if (params.token) {
      ...
      if (location.pathname && location.pathname.search('explore/installed') > -1)
  ...
  }, [clearInterval, onCancel, onConverted, params.appId, params.token, location.pathname, wordTimestamps])
