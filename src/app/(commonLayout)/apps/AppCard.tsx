...
const AppCard = ({ app, onRefresh }: AppCardProps) => {
    ...
    const onCopy: DuplicateAppModalProps['onConfirm'] = async ({
        ...
        try {
            ...
            mutateApps();
            onPlanInfoChanged();
            getRedirection(isCurrentWorkspaceEditor, newApp, navigate);
        } catch {
                    ...
                    <div className="flex h-5 w-5 shrink-0 items-center justify-center">
                        {app.access_mode === AccessMode.PUBLIC && (
                            <Tooltip
                                asChild={false}
                                popupContent={t(
                                    'app.accessItemsDescription.anyone',
                                )}
                            >
                        ...
                        {app.access_mode ===
                            ...
                            <Tooltip
                                asChild={false}
                                popupContent={t(
                                    'app.accessItemsDescription.specific',
                                )}
                            >
                        ...
                        {app.access_mode === AccessMode.ORGANIZATION && (
                            <Tooltip
                                asChild={false}
                                popupContent={t(
                                    'app.accessItemsDescription.organization',
                                )}
                            >
                ...
                >
                    {isCurrentWorkspaceEditor && (
                        <>
                            <div
                                className={cn(
                                    'flex w-0 grow items-center gap-1',
                                )}
                                onClick={(e) => {
                                    e.stopPropagation();
                                    e.preventDefault();
